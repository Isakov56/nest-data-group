    ...
    >
      ...
      <div className="section-container relative">
        ...
        >
          ...
          <div className="animate-item flex flex-wrap justify-center items-start gap-8 md:gap-12 lg:gap-16 opacity-0">
            {/* Email */}
            <a
              href="mailto:contact@nestdatagroup.com"
              className="group flex items-center gap-3 text-navy-600 hover:text-teal-600 transition-colors duration-300"
            >
              <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="font-body text-sm">contact@nestdatagroup.com</span>
            </a>
            ...
            <div className="flex items-start gap-3 text-navy-600">
              ...
              <div className="flex flex-col gap-1">
                <a href="tel:+998942954070" className="font-body text-sm hover:text-teal-600 transition-colors duration-300">
                  +998 94 295 4070
                </a>
                <a href="tel:+998507440370" className="font-body text-sm hover:text-teal-600 transition-colors duration-300">
                  +998 50 744 0370
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 text-navy-600">
              ...
              <span className="font-body text-sm">{t('washingtonDC')}</span>
            </div>
          </div>
        </div>
      </div>
